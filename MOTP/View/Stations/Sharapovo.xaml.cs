...
private void TBNacl_KeyDown(object sender, KeyEventArgs e)
{
    if (e.Key == Key.Enter)
    {
        ...
        {
            _home.AddProd(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                                      Stat.Sharapovo._listPal, TBNacl, TBPlmb, "паллет", "", ListPal);

            _home.ReloadList(ListPal, Stat.Sharapovo._listPal);
            _home.ReloadList(ListGM, Stat.Sharapovo._listGM);
            _home.ReloadList(ListMesh, Stat.Sharapovo._listMesh);
            _home.ReloadList(ListCont, Stat.Sharapovo._listCont);

            _home.ReloadDTInfo(Stat.Sharapovo._listPal, TBO_Pal, false);
            _home.ReloadDTInfo(Stat.Sharapovo._listGM, TBO_GM, false);
            _home.ReloadDTInfo(Stat.Sharapovo._listMesh, TBO_Mesh, true);
            _home.ReloadDTInfo(Stat.Sharapovo._listCont, TBO_Cont, true);
            return;
        }
        ...
        if (CBType.SelectedIndex == 0 || CBType.SelectedIndex == 1 || CBType.SelectedIndex == 4 || CBType.SelectedIndex == 5)
        {
            switch (CBType.SelectedIndex)
            {
                ...
                case 1:
                    _home.AddProd(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                                      Stat.Sharapovo._listGM, TBNacl, TBPlmb, "гм", "1", ListGM);
                    _home.ReloadList(ListGM, Stat.Sharapovo._listGM);
                    _home.ReloadDTInfo(Stat.Sharapovo._listGM, TBO_GM, false);
                    break;
                ...
                case 4:
                    _home.AddProd(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                                      Stat.Sharapovo._listSave, TBNacl, TBPlmb, "сейфпакет");
                    break;
                case 5:
                    _home.AddProd(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                                      Stat.Sharapovo._listZas, TBNacl, TBPlmb, "гм", "1");
                    break;
            }
        }
    ...
    if (e.Key == Key.Enter)
    {
        ...
        if (CBType.SelectedIndex == 2 || CBType.SelectedIndex == 3)
        {
            switch (CBType.SelectedIndex)
            {
                case 2:
                    _home.AddProd(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                                      Stat.Sharapovo._listMesh, TBNacl, TBPlmb, "мешок", "", ListMesh);
                    _home.ReloadList(ListMesh, Stat.Sharapovo._listMesh);
                    _home.ReloadDTInfo(Stat.Sharapovo._listMesh, TBO_Mesh, true);
                    break;
                case 3:
                    _home.AddProd(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                                      Stat.Sharapovo._listCont, TBNacl, TBPlmb, "контейнер", "", ListCont);
                    _home.ReloadList(ListCont, Stat.Sharapovo._listCont);
                    _home.ReloadDTInfo(Stat.Sharapovo._listCont, TBO_Cont, true);
                    break;
            }
...
{
    _home.ListSelectionWeb(ListPal, TBO_Pal, Stat.Sharapovo._listPal, false, Stat.Sharapovo.numstation);
}

private void ListGM_SelectionChanged(object sender, SelectionChangedEventArgs e)
{
    _home.ListSelectionWeb(ListGM, TBO_GM, Stat.Sharapovo._listGM, false, Stat.Sharapovo.numstation);
}

private void ListMesh_SelectionChanged(object sender, SelectionChangedEventArgs e)
{
    _home.ListSelectionWeb(ListMesh, TBO_Mesh, Stat.Sharapovo._listMesh, true, Stat.Sharapovo.numstation);
}

private void ListCont_SelectionChanged(object sender, SelectionChangedEventArgs e)
{
    _home.ListSelectionWeb(ListCont, TBO_Cont, Stat.Sharapovo._listCont, true, Stat.Sharapovo.numstation);
}
...
public void BTN_Otch_Click(object sender, RoutedEventArgs e)
{
    ...
    _home.FormOtch(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas,
                   TB_autoplomb, RTBoooinn, TB_FIO, TB_March, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Sharapovo.sdach, Stat.Sharapovo.poluch);
}
...
{
    _home.OpenDop(Stat.Sharapovo._listSave, Stat.Sharapovo._listZas, Stat.Sharapovo.numstation);
}

private void TB_March_Loaded(object sender, RoutedEventArgs e)
{
    TB_March.Text = Stat.Sharapovo.march;
}

private void TB_March_LostFocus(object sender, RoutedEventArgs e)
{
    Stat.Sharapovo.march = TB_March.Text;
}

private void BTN_Sett_Click(object sender, RoutedEventArgs e)
{
    _home.OpenSett(Stat.Sharapovo.numstation);
}
...
private void BTN_Form_Click(object sender, RoutedEventArgs e)
{
    ...
    _home.OpenComp(Stat.Sharapovo._listPal, Stat.Sharapovo._listGM, Stat.Sharapovo._listMesh, Stat.Sharapovo._listCont, Stat.Sharapovo._listSave, Stat.Sharapovo._listZas, TB_autoplomb, RTBoooinn, TB_FIO, TB_March, TB_Phone, RTBdt, TB_Auto1, TB_Auto2, Stat.Sharapovo.sdach, Stat.Sharapovo.poluch, Stat.Sharapovo.numstation);
}

private void TB_Phone_Loaded(object sender, RoutedEventArgs e)
{
    TB_Phone.Text = Stat.Sharapovo.phone;
}

private void TB_Phone_LostFocus(object sender, RoutedEventArgs e)
{
    Stat.Sharapovo.phone = TB_Phone.Text;
}

private void TB_autoplomb_Loaded(object sender, RoutedEventArgs e)
{
    TB_autoplomb.Text = Stat.Sharapovo.autoplomb;
}

private void TB_autoplomb_LostFocus(object sender, RoutedEventArgs e)
{
    Stat.Sharapovo.autoplomb = TB_autoplomb.Text;
}
